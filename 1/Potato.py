...
for t in range(len(X1)):
    draw_rect(249, 201, 41, 200+20*X1[l], 200+20*Y1[l])
    l+=1;
l=0;
for t in range(len(X2)):
    draw_rect(249, 190, 40, 200+20*X2[l], 200+20*Y2[l])
    l+=1;
l=0;
for t in range(len(X3)):
    draw_rect(200, 150, 29, 200 + 20 * X3[l], 200 + 20 * Y3[l])
    l += 1;
l=0;
for t in range(len(X4)):
    draw_rect(148, 103, 21, 200+20*X4[l], 200+20*Y4[l])
    l+=1;
l=0;
for t in range(len(X5)):
    draw_rect(252, 240, 184, 200+20*X5[l], 200+20*Y5[l])
    l+=1;
l=0;
for t in range(len(X6)):
    draw_rect(250, 223, 116, 200+20*X6[l], 200+20*Y6[l])
    l+=1;
l=0;
for t in range(len(X7)):
    draw_rect(250, 223, 110, 200+20*X7[l], 200+20*Y7[l])
    l+=1;
