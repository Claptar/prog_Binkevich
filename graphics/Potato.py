...
for t in range(len(X1)):
    draw_rect(249, 201, 41, 200 + 20 * X1[column], 200 + 20 * Y1[column])
    column += 1
column = 0
for t in range(len(X2)):
    draw_rect(249, 190, 40, 200 + 20 * X2[column], 200 + 20 * Y2[column])
    column += 1
column = 0
for t in range(len(X3)):
    draw_rect(200, 150, 29, 200 + 20 * X3[column], 200 + 20 * Y3[column])
    column += 1
column = 0
for t in range(len(X4)):
    draw_rect(148, 103, 21, 200 + 20 * X4[column], 200 + 20 * Y4[column])
    column += 1
column = 0
for t in range(len(X5)):
    draw_rect(252, 240, 184, 200 + 20 * X5[column], 200 + 20 * Y5[column])
    column += 1
column = 0
for t in range(len(X6)):
    draw_rect(250, 223, 116, 200 + 20 * X6[column], 200 + 20 * Y6[column])
    column += 1
column = 0
for t in range(len(X7)):
    draw_rect(250, 223, 110, 200 + 20 * X7[column], 200 + 20 * Y7[column])
    column += 1
